...
I design cloud and AI architectures for financial services and other regulated industries — environments where failure is not an option.

- 🏗️ Production infrastructure: Kubernetes, multi-region, payment-grade availability
- 🤖 AI Agents in the enterprise: A2A, MCP, security & governance constraints
- 🔀 Where they meet — my current focus: agents as first-class workloads on existing production infrastructure: observability, security boundaries, lifecycle management, and the evals & QA to prove they're production-ready
- ✍️ Writing: [blog.makotow.net](https://blog.makotow.net)

### Interests
`ai-agents` `agent-evals` `agent-infrastructure` `mcp` `llm-testing` `kubernetes` `observability` `go` `rust` `fintech-infrastructure`
...
<a href="https://blog.makotow.net" target="blank"><img align="center" src="https://api.iconify.design/mdi/rss.svg?color=%23f26522" alt="blog" height="30" width="40" /></a>
</p>
